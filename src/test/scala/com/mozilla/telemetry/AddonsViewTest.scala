...
import com.mozilla.telemetry.views.{ParquetAddon, AddonsView}
...
case class PartialMain(document_id: String,
                       ...
                       active_addons: Seq[ParquetAddon])
    ...
    try {
      val mains = Seq(
        PartialMain("doc1", "client1", 1l, "2016-10-01T00:00:00", "release", Seq(
          ParquetAddon("addon1", true, "addon1name", false, false, "1.0", 1, "plugin", true, false, 10, 11, 0, true),
          ParquetAddon("addon2", true, "addon2name", false, false, "1.0", 1, "plugin", true, false, 10, 11, 0, false))),
        ...
        PartialMain("doc4", "client3", 3l, "2016-10-01T00:00:00", "release", Seq(
          ParquetAddon("addon1", true, "addon1name", false, false, "1.0", 1, "plugin", true, false, 10, 11, 0, true),
          ParquetAddon("addon3", true, "addon3name", false, false, "1.0", 1, "plugin", true, false, 10, 11, 0, false),
          ParquetAddon("addon4", true, "addon4name", false, false, "1.0", 1, "plugin", true, false, 10, 11, 0, false)))
      ).toDS().toDF()
