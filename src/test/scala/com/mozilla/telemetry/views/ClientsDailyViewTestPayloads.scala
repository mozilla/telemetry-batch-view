...
object ClientsDailyViewTestPayloads {
  ...
  case class MainSummaryRow(
    ...
    scalar_parent_services_sync_fxa_verification_method: Option[String] = None,
    scalar_parent_storage_sync_api_usage_extensions_using: Option[Int] = None,
    scalar_parent_telemetry_os_shutting_down: Option[Boolean] = None,
  ...
  def getRowAggFirst(sValue: Option[String], bValue: Option[Boolean], iValue: Option[Int]) = MainSummaryRow(
    ...
    scalar_parent_services_sync_fxa_verification_method = sValue,
    scalar_parent_telemetry_os_shutting_down = bValue,
  ...
  def getExpectAggSum(value: Int) = Map(
    ...
    "scalar_parent_webrtc_nicer_stun_retransmits_sum" -> value,
    "scalar_parent_webrtc_nicer_turn_401s_sum" -> value,
    "scalar_parent_webrtc_nicer_turn_403s_sum" -> value,
    "scalar_parent_webrtc_nicer_turn_438s_sum" -> value,
