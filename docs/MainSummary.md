...
The Main Summary dataset is generated by `src/main/scala/com/mozilla/telemetry/views/MainSummaryView.scala`. It contains one record for every [main ping](https://gecko.readthedocs.org/en/latest/toolkit/components/telemetry/telemetry/main-ping.html) submitted by Desktop Firefox.
